...
class HssDecoder(nn.Module):
    def __init__(self, vocab_size, embed_size, hidden_size, num_layers, memory_bank_size, coverage_attn, copy_attn,
                 review_attn, pad_idx, attn_mode, dropout=0.0, hr_enc=False):
        super(HssDecoder, self).__init__()
        ...
        if self.hr_enc:
            ...
            merged_memory_bank_size = 2 * memory_bank_size
    ...
    def forward(self, y, h, memory_banks, src_masks, max_num_oovs, src_oov, coverage, decoder_memory_bank=None, goal_vector=None):
        ...
        sentiment_context, sentiment_attn_dist, _ = self.sentiment_attention_layer(last_layer_h_next, word_memory_bank, word_src_mask, coverage=None)
        ...
        # sentiment_context: [batch_size, memory_bank_size]
